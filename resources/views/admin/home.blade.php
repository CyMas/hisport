	...
	<div class="row">
		...
		<div class="panel panel-default">
			<div class="alert bg-primary" role="alert">
				<svg class="glyph stroked empty-message"><use xlink:href="#stroked-empty-message"></use></svg> Selamat Datang di HiSport, <b><i>{{ Auth::user()->name }}!</i></b> <a href="#" class="pull-right"></a>
			</div>
		</div>
		</div>
		<div class="col-md-4">
